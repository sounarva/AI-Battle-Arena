                        ...
                        <div className="space-y-2">
                            ...
                            <div className="relative">
                                <input
                                    ...
                                    id='password' className="w-full bg-surface-container-lowest/30 border border-outline-variant/20 rounded-lg px-5 py-3.5 text-on-surface placeholder:text-outline/50 focus:outline-none focus:border-primary/40 focus:ring-1 focus:ring-primary/40 transition-all backdrop-blur-md" placeholder="••••••••" type={showPassword ? "text" : "password"} />
